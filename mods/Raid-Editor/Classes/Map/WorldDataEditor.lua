...
function WData:build_default_menu()
    ...
    local function make_alert(text)
        ...
        self:SmallImageButton("Alert", nil, "ui/atlas/raid_atlas_menu", {460, 986, 32, 32}, div, {
    ...
    self:Button("Assets", self._assets_manager and ClassClbk(self._assets_manager, "Show") or nil, {group = managers_group, enabled = Global.current_custom_level ~= nil})
    self:Button("Objectives", self._objectives_manager and ClassClbk(self._objectives_manager, "Show") or nil, {group = managers_group, enabled = Global.current_custom_level ~= nil})
